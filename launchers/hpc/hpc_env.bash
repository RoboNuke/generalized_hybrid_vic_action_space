...
: "${HPC_PARTITIONS:=dgxh,tiamat,eecs2}"                 # -p  partition list. Excludes: gpu (AllowAccounts=eecs,coeit, not virl-grp); dgx2 (V100/sm_70, unsupported by torch cu128 -> "no kernel image")
